...
/* MAXESS-AAA-CONSOLIDATED-JS */
  ...
  function build(r){
    ...
    var preservedMedia=[];
    root.querySelectorAll('video,iframe[src*=youtube],iframe[src*=vimeo],audio').forEach(function(media){var holder=media.closest('section,.mx-section,.mx-reading,.mx-wide')||media.parentElement;if(holder&&holder!==root&&!preservedMedia.includes(holder)&&!(preservedPlay&&holder.contains(preservedPlay)))preservedMedia.push(holder)});
    ...
    var sorted=ds.slice().sort(function(a,b){return (b.score||0)-(a.score||0)}), strongest=sorted[0], lowest=sorted[sorted.length-1];
    ...
    root.innerHTML=''+
      ...
      '<section class="v21-section v21-dark"><div class="v21-inner">'+
        '<div class="v21-naya">'+
          ...
          '<div><span class="v21-kicker">NAYA · YOUR AI GUIDE</span><h1 class="v21-naya-title">'+(name ? reportName : 'Hi. I\'ve looked at your results.')+'</h1><p class="v21-naya-sub">This isn\'t your judgment. <strong>It\'s your map.</strong></p></div>'+
    ...
    aaaEnhance(r,ds,strongest,lowest,preservedPlay,preservedMedia);
