...
def main():
    ...
    for phrase in ('MISSION','SOURCE OF TRUTH','CURRENT STATE','SCOPE','completion criteria','EXECUTE','VERIFY','OSCAR','SCORE','INTEGRATE','CAPTURE','CHECK NETWORK','NEXT BLOCK','CONTINUOUS BLOCK EXECUTION LAW','Review cadence','WHY IS THIS NOT A 10?','ready-to-run **NEXT EXECUTION**'): require(policy,phrase,'block operating contract')
