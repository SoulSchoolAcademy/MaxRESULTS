...
def self_test():
    ...
    base={'event_id':'SE-20260825-999999-contract-test','event_type':'implementation','project':'Test Project','project_context':{'project_id':'PRJ-TEST','current_objective':'test'},'representations':{'naya':{'id':'SN-20260825-999999-naya','canonical_event_id':'SE-20260825-999999-contract-test','lessons':['test learning']},'shawn':{'id':'SN-20260825-999999-shawn','canonical_event_id':'SE-20260825-999999-contract-test','lessons':['test lesson']}},'continuity':{'learning_status':'LEARNED'},'next_execution':{'path':'.naya/handoffs/NEXT-EXECUTION-TEST.md'}}
